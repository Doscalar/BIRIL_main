...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
                 base_width=64, dilation=1, norm_layer=None, spiking_neuron: callable = neuron.IFNode(), **kwargs):
        ...
        self.MaxPool1 = layer.MaxPool2d(kernel_size=3, stride=1, padding=1)
        self.bn1 = norm_layer(planes)
        self.sn1 = neuron.IFNode()
        self.conv2 = conv3x3(planes, planes)
        self.MaxPool2 = layer.MaxPool2d(kernel_size=3, stride=1, padding=1)
...
class SpikingResNet(nn.Module):
    def __init__(self, block, layers, num_classes=100, zero_init_residual=False,
                 ...
                 norm_layer=None, spiking_neuron: callable = neuron.IFNode,T= 4, **kwargs):
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilate=False, spiking_neuron: callable = neuron.IFNode, **kwargs):
